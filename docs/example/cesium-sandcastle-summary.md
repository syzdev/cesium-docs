...
| [Montreal Point Cloud](https://sandcastle.cesium.com/?src=Montreal%20Point%20Cloud.html&label=All) | 蒙特利尔（加拿大魁北克省南部一城市）的区域点云数据           |                                                              |
| [Sample Height from 3D Tiles](https://sandcastle.cesium.com/?src=Sample%20Height%20from%203D%20Tiles.html&label=All) | 获取3D Tiles表面高度                                         |                                                              |
| [Time Dynamic Point Cloud](https://sandcastle.cesium.com/?src=Time%20Dynamic%20Point%20Cloud.html&label=All) | 随时间变化的点云数据                                         |                                                              |
## 实体 Entity
| 案例名称 / 链接                                              | 案例内容                                                     | 图例 |
| ------------------------------------------------------------ | ------------------------------------------------------------ | ---- |
